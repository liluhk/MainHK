function QuoteStrip() {
  return (
    <section className="hk-quote" style={{ background: "var(--surface-card)", borderTop: "1px solid var(--border-subtle)", borderBottom: "1px solid var(--border-subtle)", position: "relative", overflow: "hidden" }}>
      ...
      <div style={{ position: "relative", maxWidth: "640px", margin: "0 auto", padding: "28px 32px", display: "flex", alignItems: "flex-start", gap: "28px" }}>
        <div style={{ display: "flex", flexDirection: "column", gap: "16px", textAlign: "left" }}>
          <p style={{ margin: 0, fontFamily: "var(--font-display)", fontWeight: 400, fontSize: "25px", lineHeight: 1.4, color: "var(--text-strong)" }}>
            We built Healthy Kitchen on one belief:<br />
            <span style={{ fontFamily: "var(--font-script)", color: "var(--green-700)" }}>food should heal, not harm.</span><br />
